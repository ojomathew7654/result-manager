      ...
      <Card>
        <CardBody className="overflow-x-auto p-0">
          <table className="min-w-full text-left text-sm">
            ...
            {loading ? <tbody><tr><td colSpan="7" className="px-5 py-10 text-center text-ink-400">Loading students...</td></tr></tbody> : (
              ...
              {students.map((student, index) => (
                <tr key={student.id}>
                  ...
                  <td className="whitespace-nowrap px-4 py-3">
                    <Link className="mr-3 font-medium text-brand-700 hover:text-brand-900" href={`/admin/secondary/${student.id}`}>Edit</Link>
